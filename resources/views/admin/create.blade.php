                    ...
                    <div class="grid bg-white rounded-lg shadow-xl w-11/12 md:w-9/12 lg:w-1/2">
                        ...
                        @csrf
                            ...
                            <div class="grid grid-cols-1">
                                ...
                                <input class="py-2 px-3 rounded-lg border-2 border-green-400 mt-1 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent" type="datetime-local" id="date" name="date" />
                            </div>
                            <div class="grid grid-cols-1">
