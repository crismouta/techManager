        ...
        <table class="min-w-full divide-y divide-gray-200">
            ...
            <tr>@foreach ($events as $event)
                ...
                <div class="flex-shrink-0 h-10 w-20">
                    <img class="h-10 w-20" src="{{asset('storage').'/'.$event->image}}" alt=""> <!-- <img src="{{asset('storage').'/'.$event->photo}}"> Seguido del comando en terminal: php artisan storage:link  // Copiar y pegar el <img> en el edit.blade para que aparezca -->
                  </div>
                  <div class="ml-4">
