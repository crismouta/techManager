                                    ...
                                    @foreach ($events->sortBy('date') as $event)
                                        <tr>
                                            ...
                                            @if(count($event->users) < $event->capacity)
                                                ...
                                                @foreach($events as $event)
                                                @if($event->date < now()) 
                                                <td class="px-6 py-4 whitespace-wrap w-92 bg-gray-100">
                                                    <div class="flex items-center w-92">
                                                        <div class="flex-shrink-0 h-16 w-32">
                                                            <a href="{{url('/show/'.$event->id)}}" class="text-gray-600 hover:text-gray-900">
                                                        ...
                                                        <div class="ml-4">
                                                            <p href="{{url('/show/'.$event->id)}}" class="text-gray-400 ">{{$event->title}}</p>
                                                        </div>
                                                    </div>
                                                    </td>
                                                    ...
                                                    <td class="px-4 py-4 whitespace-nowrap bg-gray-100">
                                                        @if(count($event->users) >= $event->capacity)
                                                        <span class="px-4 inline-flex text-xs leading-5 font-semibold bg-gray-200 text-gray-400">
                                                            Full
                                                        </span>
                                                        @endif
                                                        @if(count($event->users) < $event->capacity)
