...
<div class="flex justify-between m-6">
  <div class="flex flex-col h-full w-4/5 mx-auto bg-green-100 rounded-lg">
          ...
          <div class="py-2 px-4">
            ...
            >
              <a href="blog/detail"><?php echo e($event->title); ?></a>
            </h1>
          </div>
    ...
    <!--<div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                ...
                <!--<form action="<?php echo e(url('/events/edit/'.$event->id)); ?>" method="post" enctype="multipart/form-data"> -->
            ...
            <tr>
              <td class="px-6 py-4 whitespace-nowrap">
                ...
                <div class="flex-shrink-0 h-10 w-20">
                    <img class="h-10 w-20" src="<?php echo e(asset('storage').'/'.$event->image); ?>" alt="">   <!--Copiar y pegar el <img> en el edit.blade para que aparezca -->
                  <!-- </div>
                  <div class="ml-4">
                  <div class="text-gray-600"><?php echo e($event->title); ?></div>
                  </div>
                </div>
              </td>
              <td class="px-6 py-4 whitespace-nowrap">
              ...
              <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
               ...
               <!-- <a href="<?php echo e(url('/events/edit/'.$event->id)); ?>" class="bg-white text-indigo-600 hover:text-indigo-900">Edit</a>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\techManager\resources\views/user/show.blade.php ENDPATH**/ ?>