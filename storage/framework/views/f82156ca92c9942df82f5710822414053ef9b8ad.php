                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    ...
                    <div class="flex h-screen bg-gray-200 items-center justify-center  mt-32 mb-32">
                        <div class="grid bg-white rounded-lg shadow-xl w-11/12 md:w-9/12 lg:w-1/2">
                            ...
                            <form action="<?php echo e(url('/admin/edit/'.$event->id)); ?>" method="post" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <?php echo e(method_field('PATCH')); ?>

                                <div class="grid grid-cols-1 mt-5 mx-7">
                                    <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Title</label>
                                    <input class="py-2 px-3 rounded-lg border-2 border-green-400 mt-1 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent" name="title" value="<?php echo e($event->title); ?>" id="title" type="text" placeholder="Title" />
                                </div>

                                <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
                                    <div class="grid grid-cols-1">
                                        <label for="date" class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Date/s</label>
                                        <input class="py-2 px-3 rounded-lg border-2 border-green-400 mt-1 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent" value="<?php echo e(date('d/m/Y', strtotime($event->date))); ?>" type="date" id="date" name="date" />
                                    </div>
                                    <div class="grid grid-cols-1">
                                        <label class="uppercase md:text-sm text-xs text-gray-500 text-light font-semibold">Available places</label>
                                        <input class="py-2 px-3 rounded-lg border-2 border-green-400 mt-1 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent" name="capacity" value="<?php echo e($event->capacity); ?>" id="capacity" type="text" placeholder="Available places" />
                                    </div>
                                </div>
                                ...
                                <div class="grid grid-cols-1 mt-5 mx-7">
                                    ...
                                    <textarea rows="6" class="py-2 px-3 rounded-lg border-2 border-green-400 mt-1 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent" name="description" id="description"><?php echo e($event->description); ?></textarea>
                                    ...
                                    <div class='flex items-center justify-center w-full'>
                                        <label class='flex flex-col border-4 border-dashed w-full h-32 hover:bg-gray-100 hover:border-green-400 group'>
                                            ...
                                            <div class='flex flex-col items-center justify-center align-center pt-7'>
                                                <img src="<?php echo e(asset('storage').'/'.$event->image); ?>" width="120" alt="">
                                                <?php endif; ?>
...
<?php endif; ?><?php /**PATH C:\xampp\htdocs\techManager\resources\views/admin/edit.blade.php ENDPATH**/ ?>